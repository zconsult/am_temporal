...
from internals.cheater import cheating_with_secret as cheater_call
...
async def compute_daily_returns2(daily_data_object_in_minio: str) -> str:
    ...
    print(f'\ncompute_daily_returns finished\n')
